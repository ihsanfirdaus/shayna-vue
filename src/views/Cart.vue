                                ...
                                <div class="user-checkout">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input v-model="customerInfo.name" type="text" class="form-control" id="name" aria-describedby="namaHelp" placeholder="Masukan Nama">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email Address</label>
                                            <input v-model="customerInfo.email" type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Masukan Email">
                                        </div>
                                        <div class="form-group">
                                            <label for="number">No. HP</label>
                                            <input v-model="customerInfo.number" type="text" class="form-control" id="number" aria-describedby="noHPHelp" placeholder="Masukan No. HP">
                                        </div>
                                        <div class="form-group">
                                            <label for="address">Alamat Lengkap</label>
                                            <textarea v-model="customerInfo.address" class="form-control" id="address" rows="3"></textarea>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
export default {
    ...
    methods: {
        ...
        checkout() {
            ...
            axios.post('http://ihsanfirdaus.my.id/api/checkout', checkoutData)
